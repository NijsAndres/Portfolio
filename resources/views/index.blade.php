            ...
            <div class="row">
                ...
                <div class="col-xl-4 offset-lg-1 col-lg-5 u-fade-in-right">
                    <div class="c-hero__imgcontainer">
                        <img class="c-hero__img" src="{{ asset('assets/'.$hero->image_path) }}" alt="Background image" width="1920" height="1920" fetchpriority="high">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-6">
                            <button type="button" class="c-projects__card js-project-card"
                                ...
                                <div class="c-projects__cardimgcontainer">
                                    <img class="c-projects__cardimg" src="{{ asset('assets/'.$project->image_path) }}" alt="Mockup of {{ $project->title }}" width="1920" height="1079" loading="lazy">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 offset-lg-4 offset-md-4 col-12">
                    ...
                    <ul class="c-footer__nav">
                        <li class="c-footer__navitem"><a class="c-footer__navlink" href="{{ asset('assets/'.$cvPath) }}" download>Download CV</a></li>
